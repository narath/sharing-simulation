...
class Simulation
  attr_accessor :filename, :r0, :rt, :reaction_time_to_distance, :reaction_time_to_reopen, :relax_when_new_daily_infections_is_less_than

  def initialize(filename, r0: R0, rt: Rt, reaction_time_to_distance: 2, reaction_time_to_reopen: 2, relax_when_new_daily_infections_is_less_than: RELAX_WHEN_NEW_DAILY_INFECTIONS_IS_LESS_THAN)
    @filename = filename
    @r0 = r0
    @rt = rt
