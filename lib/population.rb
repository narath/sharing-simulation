...
class Population
  ...
  def initialize(name, resource_controller, size: POPULATION, r0: R0, rt: Rt, reaction_time_to_distance: 2, reaction_time_to_reopen: 2, relax_when_new_daily_infections_is_less_than: nil)
    @name = name
